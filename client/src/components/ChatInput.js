...
const ChatInput = (props) => {
  const handleSubmit = (e) => {
    ...
    axios.post(`https://${props.SERVER}:9000/new_message`, document.querySelector('#message-form'), {
      headers: {
  ...
  return (
    <form id='message-form' method="POST" action={`https://${props.SERVER}:9000/new_message`} onSubmit={handleSubmit}>
